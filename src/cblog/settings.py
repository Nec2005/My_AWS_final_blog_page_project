...
DATABASES = {
    'default': {
        ...
        'NAME': 'tomas_capstone', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'capstone-rds-server.caauu1jlpbln.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'mycapstone-app-tomas' # please enter your s3 bucket name
